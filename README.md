...
- **Modes** — one white-key tuning (**C D E F G A**) and the seven diatonic modes rooted on C, ordered brightest→darkest so each mode flattens one string. In this section the **Bends** pedals bend to the current mode's 7th degree — Pedal A lifts the high E up, Pedal B drops the low E down — retargeting with each mode.
